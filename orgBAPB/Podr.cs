...
namespace orgBAPB
{
    class Podr
    {
        ...
        public string codeSp; // 4.	управления, центра (для самостоятельных структурных подразделений Центрального аппарата - отдел, сектор), РКЦ, ЦБУ и (или) филиала, РД))
        ...
        public int housenumber; // 13.	номер дома
        public int buildnumber; //14.	номер корпуса
